...
import "./signin.css"
import { FaUserAlt, FaInstagram, FaFacebookSquare, FaTwitter } from "react-icons/fa";
...
const Signin = () => {
    ...
    return <>
        <div className="mainDiv">
            ...
            >
                <div className="input-group userNameBox">
                    <input
                        type="text"
                        name="email"
                    ...
                    <div className="input-group mb-3 password">
                        ...
                        />
                        {
                            showPassword === 'password' ?
                                <AiFillEyeInvisible className="showBtn"
                                    onClick={sPassword}
                                    style={{
                                        position: 'relative',
                                        right: '2px',
